...
INSERT INTO `wp_comments` VALUES (1,1,_binary 'WordPress コメントの投稿者',_binary 'wapuu@wordpress.example',_binary 'https://ja.wordpress.org/','','2023-11-08 22:38:10','2023-11-08 13:38:10',_binary 'こんにちは、これはコメントです。\nコメントの承認、編集、削除を始めるにはダッシュボードの「コメント」画面にアクセスしてください。\nコメントのアバターは「<a href=\"https://ja.gravatar.com/\">Gravatar</a>」から取得されます。',0,_binary '1','',_binary 'comment',0,0);
...
INSERT INTO `wp_users` VALUES (1,_binary 'admin',_binary '$P$BonmqeKelaPT3yT0y33kB9tF5pJJOU1',_binary 'admin',_binary 'dev@example.com',_binary 'http://localhost','2023-11-08 13:38:10','',0,_binary 'admin');
...
-- Dump completed on 2023-11-08 13:38:31
